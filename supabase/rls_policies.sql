...
USING (EXISTS (SELECT 1 FROM "Project" WHERE id = "Stand"."projectId"));
...
USING (EXISTS (SELECT 1 FROM "Project" WHERE id = "Brief"."projectId"));
...
USING (EXISTS (SELECT 1 FROM "Project" WHERE id = "Document"."projectId"));
...
USING (EXISTS (SELECT 1 FROM "Project" WHERE id = "AIJob"."projectId"));
...
USING (EXISTS (SELECT 1 FROM "Project" WHERE id = "Extraction"."projectId"));
...
USING (EXISTS (SELECT 1 FROM "Project" WHERE id = "Constraint"."projectId"));
...
USING (EXISTS (SELECT 1 FROM "Project" WHERE id = "Concept"."projectId"));
...
USING (EXISTS (SELECT 1 FROM "Project" WHERE id = "CostEstimate"."projectId"));
...
USING (EXISTS (SELECT 1 FROM "Project" WHERE id = "Report"."projectId"));
...
USING (EXISTS (SELECT 1 FROM "Document" WHERE id = "DocumentChunk"."documentId"));
...
USING (EXISTS (SELECT 1 FROM "Concept" WHERE id = "ConceptVersion"."conceptId"));
